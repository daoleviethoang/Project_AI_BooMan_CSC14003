...
font4 = pygame.font.Font(r'font4.ttf', 110)
font5 = pygame.font.Font(r'font4.ttf', 50)
font6 = pygame.font.Font(r'font4.ttf', 25)
font7 = pygame.font.Font(r'font4.ttf', 34)
font8 = pygame.font.Font(r'font4.ttf', 83)

image2 = pygame.image.load(r'background2.png')
trophy = pygame.image.load(r'award.png')
...
def winning_screen(flag, score, time):
    ...
    while True:
        ...
        rect1 = draw_Text2("MAIN MENU", font6, FONT2_MENU_COLOR, screen, 300, 515)
        rect2 = draw_Text2("EXIT", font6, FONT2_MENU_COLOR, screen, 515, 515)
        underline1 = pygame.Rect(266, 530, 70, 3)
